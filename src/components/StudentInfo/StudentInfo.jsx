  ...
  return (
    <Container maxWidth="sm">
      ...
      >
        <Alert onClose={handleClose} severity="success" sx={{ width: "100%" }}>
          {!error
            ...
            : "There was an error submitting the form! Please try again at a later time"}
        </Alert>
      </Snackbar>
      <Box component="form" onSubmit={formik.handleSubmit}>
        ...
        <FormControl fullWidth sx={{ marginBottom: 2 }}>
          <TextField
            label="Intended University First Major"
            name="intendedUniversityMajor1"
            onChange={formik.handleChange}
          />
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 2 }}>
          <TextField
            label="Intended University Second Major"
            name="intendedUniversityMajor2"
            onChange={formik.handleChange}
          />
        </FormControl>
        <FormControl fullWidth sx={{ marginBottom: 2 }}>
        ...
        <FormControl fullWidth sx={{ marginBottom: 2 }}>
          ...
          <Typography variant="caption" color="textSecondary">
            The file should be a PDF that contains transcripts from class 10,
            11, and 12.
          </Typography>
        </FormControl>
